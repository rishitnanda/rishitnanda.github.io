...
- **Problem (768px-1023px Bug)**: Previously, a "dead zone" existed at 768px-1023px. CSS thought it was mobile (hiding the hover sidebar), but JS thought it was desktop (failing to inject inline images).
